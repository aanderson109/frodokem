 ...
 * @brief FrodoKEM-1344-AES for TM4C1294NCPDT
 * @version 0.1
 * @date 2026-04-13
 * 
 * Runs Frodo.KeyGen, Frodo.Encaps, and Frodo.Decaps on the TM4C1294NCPDT
...
#include "../vendor/tivaware/inc/tm4c1294ncpdt.h"
